...
I made some additions in the Oython program for my SLA5520's. This code is marked by comments with SLA5520. The code is meant to change https into http because the these streamers do not support https. See also my repository "proxy".
